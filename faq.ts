...
const faq: FAQ[] = [
  ...
  },
  {
    q: 'How do I apply?',
    a:
      'Thanks for your interest! Applications can be found above at the "Sign Up Here" link!',
  },
  {
    q: 'Do I need to be a CS major?',
    a: 'We welcome all majors!',
  },
  { q: 'How old do I have to be to participate?', a: 'Participants must be 18 or older and are current students at UTD' },
